...
function getPieDataPoints(series) {
    ...
    console.log('getPieDataPoints====', series)
    return series;
}
...
function getPieTextMaxLength(series) {
    ...
    console.log('getPieTextMaxLength====', series)
    return maxLength;
}
...
function getXAxisPoints(categories, opts, config) {
    ...
    // console.log('getXAxisPoints=====', xAxisPoints, eachSpacing)
...
function drawCharts(type, opts, config, context) {
    // console.log('drawCharts ==== ',type, opts, config, context)
    var _this = this;
